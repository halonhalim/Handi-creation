	...
	<div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-2">
		<div class="widget-box widget-color-blue" id="widget-box-2">
			<div class="widget-header">
				<h5 class="widget-title bigger lighter"> <i class="ace-icon fa fa-plus-square"></i> Add News </h5>
			</div>
				...
				<div class="widget-main">
					<form id="myForm" action="<?php echo base_url() . 'news/save'; ?>" class="form-horizontal" method="post" enctype="multipart/form-data">   
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="published_date" value="<?php echo date('d-m-Y'); ?>" class="date-picker col-xs-10 col-sm-5" />
