		...
		<div class="footer-inner">
			<div class="footer-content">
				<span class="bigger-120">
					<img class="pull-right" src="<?php echo base_url()."assets/filemanager/developed.png"?>" width="75px" />
				</span>
			</div>
		</div>
	</div>
...
<script src="<?php echo base_url() . 'assets/admin/'; ?>summernote-0.8.8/summernote.js"></script>
<script>
	$('.txtDetails').summernote({
